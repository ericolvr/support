...
const FormSchema = z.object({
    ...
    description: z.string().min(2, {message: 'Mínimo 11 caracteres'}).optional(),
})
...
export function EditService() {
    ...
    const getService = async () => {
        ...
        if (response) {
            ...
            form.setValue('price', response.price.toString()) // Convert price to string
                        ...
                        <SidebarTrigger className='-ml-1' />
                            ...
                            <Breadcrumb>
                                <BreadcrumbList>
                                    ...
                                    <BreadcrumbSeparator className='hidden md:block' />
                                    <BreadcrumbItem>
                                        <BreadcrumbPage>Editando: {code}</BreadcrumbPage>
                                    </BreadcrumbItem>
                                </BreadcrumbList>
                            </Breadcrumb>
                        </div>
