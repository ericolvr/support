...
export const columns = (setAppointment: React.Dispatch<React.SetStateAction<Consolidation[]>>): ColumnDef<Consolidation>[] => [
    {
        accessorKey: 'id',
        header: () => {
            return (
    ...
    },
    {
        ...
        cell: ({ row }) => {
            return (
                <p className='text-black dark:text-white text-[14.5px]'>{row.original.supplier}</p>
            )
        }
    },
    {
